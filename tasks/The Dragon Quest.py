...
def forest():
    ...
    if choice == 1:
        time.sleep(1)
        print("Wow, those robbers are funny and friendly guys! And they even teach you some new tricks - your skills increase by +1")
        skill.gain_skills()
    if choice == 2:
...
def journey():
    print("\nTo get to the dragon, you have two possible paths: Through the Forbidden Forest or across the Serpent Sea. Choose wisely!")
    choice = input("1: Forbidden Forest or 2: Serpent Sea ? >> ")
    if choice not in options:
        print("Invalid answer. Please enter 1 or 2.")
        choice = int(input("Choose 1 or 2: >> "))
    if choice == 1:
...
def rest():
    print("\nYou are so close! In the distance, you can see the white dragon's mountain and hear it roar.")
    print("You are sitting at a clearing and enjoy your last minutes before the fight.")
...
def dragon():
    ...
    time.sleep(1)
    print("It speaks! It makes you an offer: Instead of fighting you, it would take 100 gold coins to leave.")
